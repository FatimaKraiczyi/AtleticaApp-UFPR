...
export declare const UIFormControl: import("@gluestack-ui/form-control/lib/typescript/types").IFormControlComponentType<import("react-native").ViewProps & {
    context?: any;
} & import("react").RefAttributes<unknown>, import("react-native").ViewProps, import("react-native").TextProps, Omit<any, "ref"> & React.RefAttributes<unknown>, import("react-native").ViewProps, import("react-native").TextProps, any, import("react-native").ViewProps, import("react-native").TextProps>;
...
declare const FormControl: {
    ({ className, size, ...props }: {
        ...
        context?: any;
    } & import("react").RefAttributes<unknown> & import("@gluestack-ui/form-control/lib/typescript/types").InterfaceFormControlProps & VariantProps<import("@gluestack-ui/nativewind-utils/types").TVReturnType<{
        size: {
            sm: string;
            md: string;
            lg: string;
