          ...
          <FormControl isInvalid={!!errors?.email || !validated.emailValid} className="w-full">
            ...
            validate: async (value) => {
                try {
                  ...
                  <InputField placeholder="Informe seu email" value={value} onChangeText={onChange} onBlur={onBlur} onSubmitEditing={handleKeyPress} enterKeyHint="done"/>
                </Input>)}/>
            <FormControlError>
          ...
          <FormControl isInvalid={!!errors.password || !validated.passwordValid} className="w-full">
            ...
            validate: async (value) => {
                try {
                  ...
                  <InputField type={showPassword ? "text" : "password"} placeholder="Informe sua senha" value={value} onChangeText={onChange} onBlur={onBlur} onSubmitEditing={handleKeyPress} enterKeyHint="done"/>
