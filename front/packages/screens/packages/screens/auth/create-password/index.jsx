    ...
    const onSubmit = async (data) => {
        if (data.password !== data.confirmpassword) {
            toast.show({
                ...
                render: ({ id }) => (<Toast nativeID={id} variant="accent" action="error">
          ...
          <FormControl isInvalid={!!errors.password}>
            ...
            validate: async (value) => {
                try {
                  ...
                  <InputField className="text-sm" placeholder="Nova senha" value={value} onChangeText={onChange} onBlur={onBlur} onSubmitEditing={handleKeyPress} enterKeyHint="done" type={showPassword ? "text" : "password"}/>
          ...
          <FormControl isInvalid={!!errors.confirmpassword}>
            ...
            validate: async (value) => {
                try {
                  ...
                  <InputField placeholder="Repita a senha" className="text-sm" value={value} onChangeText={onChange} onBlur={onBlur} onSubmitEditing={handleKeyPress} enterKeyHint="done" type={showConfirmPassword ? "text" : "password"}/>
