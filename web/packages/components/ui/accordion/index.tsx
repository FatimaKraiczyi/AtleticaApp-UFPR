...
const PrimitiveIcon = React.forwardRef<any, IPrimitiveIcon>(
  ({ as: AsComp, color, classNameColor, size, height, width, fill, stroke, ...props }, ref) => {
    ...
    if (AsComp) {
      ...
      return React.createElement(Svg as React.ComponentType<any>, { ref, height, width, fill, color, ...props });
  }
);
