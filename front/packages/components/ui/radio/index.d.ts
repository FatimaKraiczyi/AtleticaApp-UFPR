  ...
  Omit<
    {
      ...
      import("@gluestack-ui/radio/lib/typescript/types").InterfaceRadio &
        React.RefAttributes<
...
declare const RadioIndicator: React.ForwardRefExoticComponent<
  ...
  > &
    React.RefAttributes<unknown>
>;
declare const RadioLabel: React.ForwardRefExoticComponent<
  Omit<
    {
      className?: string | undefined;
  ...
  > &
    React.RefAttributes<unknown>
>;
declare const RadioIcon: React.ForwardRefExoticComponent<
  Omit<
