      ...
      <SafeAreaView className="w-full h-full">
        <ScrollView className="w-full h-full" contentContainerStyle={{ flexGrow: 1 }}>
          <HStack className="w-full h-full bg-background-0 flex-grow justify-center">
            <VStack className="relative hidden md:flex h-full w-full flex-1  items-center  justify-center p-7" space="md">
              <Image height="100%" width="100%" source={require("@/assets/auth/radialGradient.png")} className="object-cover" alt="Radial Gradient"/>
            </VStack>
