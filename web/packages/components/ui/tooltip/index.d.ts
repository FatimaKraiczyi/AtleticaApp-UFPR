...
export declare const UITooltip: import("@gluestack-ui/tooltip/lib/typescript/types").IToolTipComponentType<
  ...
  Omit<
    {
      ...
      > &
      import("@gluestack-ui/tooltip/lib/typescript/types").InterfaceTooltipProps &
      VariantProps<
  ...
  Omit<
    {
      ...
      VariantProps<
        import("@gluestack-ui/nativewind-utils/types").TVReturnType<
          ...
          undefined,
          "font-normal tracking-normal text-red-400 web:select-none text-xs text-typography-50",
