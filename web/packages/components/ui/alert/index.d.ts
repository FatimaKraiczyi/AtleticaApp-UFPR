...
export declare const UIAlert: import("@gluestack-ui/alert/lib/typescript/types").IAlertComponentType<
...
declare const Alert: React.ForwardRefExoticComponent<
  Omit<
    {
      ...
      > &
        ...
        import("@gluestack-ui/alert/lib/typescript/types").InterfaceAlertProps,
      "context"
    > &
      VariantProps<
        import("@gluestack-ui/nativewind-utils/types").TVReturnType<
          ...
          undefined,
          "items-center p-3 rounded flex-row",
  ...
  > &
    React.RefAttributes<unknown>
>;
declare const AlertText: React.ForwardRefExoticComponent<
  Omit<
    {
      className?: string | undefined;
      ...
      VariantProps<
        import("@gluestack-ui/nativewind-utils/types").TVReturnType<
          ...
          undefined,
          "text-typography-700 flex-1 font-normal font-body",
          import("tailwind-variants/dist/config").TVConfig<
            {
              isTruncated: {
                true: string;
  ...
  > &
    React.RefAttributes<unknown>
>;
declare const AlertIcon: React.ForwardRefExoticComponent<
  Omit<
    {
      className?: string | undefined;
