      ...
      <VStack className="w-full">
        <VStack space="xl" className="w-full">
          <FormControl isInvalid={!!errors.token}>
            ...
            <Controller defaultValue="" name="token" control={control} rules={{
            validate: async (value) => {
                try {
                  ...
                  <InputField className="text-sm" placeholder="Token" value={value} onChangeText={onChange} onBlur={onBlur} onSubmitEditing={handleKeyPress} enterKeyHint="done"/>
                </Input>)}/>
            <FormControlError>
