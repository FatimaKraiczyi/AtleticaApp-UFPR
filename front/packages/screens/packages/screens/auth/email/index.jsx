...
const EmailWithLeftBackground = () => {
    ...
    const onSubmit = async (data) => {
        ...
        if (response.success) {
            ...
            toast.show({
                placement: "bottom right",
                render: ({ id }) => (<Toast nativeID={id} variant="error" action="failed">
      ...
      <VStack className="w-full">
        <VStack space="xl" className="w-full">
          <FormControl isInvalid={!!errors.name}>
            ...
            <Controller defaultValue="" name="name" control={control} render={({ field: { onChange, onBlur, value } }) => (<Input>
                  <InputField className="text-sm" placeholder="Nome completo" value={value} onChangeText={onChange} onBlur={onBlur} enterKeyHint="done"/>
                </Input>)}/>
            <FormControlError>
          ...
          <FormControl isInvalid={!!errors.email}>
            ...
            <Controller name="email" control={control} render={({ field: { onChange, onBlur, value } }) => (<Input>
                  <InputField className="text-sm" placeholder="Email" onBlur={onBlur} type="text" value={value} onChangeText={onChange} enterKeyHint="done"/>
                </Input>)}/>
            <FormControlError>
