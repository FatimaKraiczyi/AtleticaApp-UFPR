...
export const NoItemsFound = ({ message }) => (<Center className="flex-1 mt-14 justify-center items-center h-full">
    <Image source={{
    ...
    }} style={{ width: 100, height: 100, tintColor: "#8E8E8E" }} resizeMode="contain"/>
