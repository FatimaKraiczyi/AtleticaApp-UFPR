...
declare const ContextView: import("react").ForwardRefExoticComponent<import("react-native").ViewProps & {
    context?: any;
...
declare const Badge: {
    ({ children, action, variant, size, className, ...props }: {
        ...
        context?: any;
    } & import("react").RefAttributes<unknown> & VariantProps<import("@gluestack-ui/nativewind-utils/types").TVReturnType<{
        action: {
            error: string;
            warning: string;
            success: string;
