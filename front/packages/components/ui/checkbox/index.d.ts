...
declare const Checkbox: React.ForwardRefExoticComponent<
  Omit<
    ...
    > &
      ...
      import("@gluestack-ui/checkbox/lib/typescript/types").InterfaceCheckbox &
      VariantProps<
        import("@gluestack-ui/nativewind-utils/types").TVReturnType<
          {} | {} | {},
          undefined,
          "group/checkbox flex-row items-center justify-start gap-2 web:cursor-pointer data-[disabled=true]:cursor-not-allowed",
...
declare const CheckboxIndicator: React.ForwardRefExoticComponent<
  ...
  > &
    React.RefAttributes<unknown>
>;
declare const CheckboxLabel: React.ForwardRefExoticComponent<
  Omit<
    {
      className?: string | undefined;
  ...
  > &
    React.RefAttributes<unknown>
>;
declare const CheckboxIcon: React.ForwardRefExoticComponent<
  Omit<
